...
f:Button("Lava World Flag",function()
...
f:Button("Desert World Flag",function()
...
f:Button("Ocean World Flag",function()
...
f:Button("Winter World Flag",function()
...
f:Button("Toxic World Flag",function()
...
f:Button("Candy World Flag",function()
...
f:Button("Forest World Flag",function()
...
f:Button("Storm World Flag",function()
...
f:Button("Blocky World Flag",function()
...
f:Button("Space World Flag",function()
...
f:Button("Dominus World Flag" ,function()
...
f:Button("Infinity World Flag",function()
...
f:Button("Future World Flag",function()
...
f:Button("VIP Area Flag 1",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(442.098175, 19.4701462, -1324.03174, 7.62939453e-06, 0.424398363, -0.905475736, -1.00000024, 7.62939453e-06, -4.97698784e-06, 4.97698784e-06, 0.905475736, 0.424398184)
end)

f:Button("VIP Area Flag 2",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(576.760803, 19.4701462, -1383.16907, -5.36441803e-06, -0.923601389, 0.383354396, -1, 5.36441803e-06, -1.07288361e-06, -1.07288361e-06, -0.383354396, -0.923601389)
end)

f:Button("Spawn Flag 1",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(660.070312, 19.4701462, -477.722534, 1.95503235e-05, -0.824143708, 0.566380858, -1.00000012, -1.96695328e-05, 6.07967377e-06, 6.07967377e-06, -0.566380858, -0.824143648)
end)

f:Button("Spawn Flag 2",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(429.855042, 19.4701462, -420.414368, -1.91926956e-05, -0.078424722, -0.99691999, -1, 1.91926956e-05, 1.77323818e-05, 1.77323818e-05, 0.99691999, -0.0784246922)
end)

f:Button("Spawn Flag 3",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(607.371033, 16.8682938, -232.948502, -4.05311584e-05, 0.500061035, 0.865990162, -1, -4.05311584e-05, -2.33948231e-05, 2.33948231e-05, -0.865990162, 0.500061035)
end)
