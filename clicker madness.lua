...
--setupvalue(function or som, index, new value)
    ...
    f:Button("Desert World",function()
    ...
    f:Button("Winter World",function()
    ...
    f:Button("Forest World",function()
    ...
    f:Button("Blocky World",function()
    ...
    f:Button("Dominus World",function()
    ...
    f:Button("Infinity World",function()
    ...
    f:Button("Future World",function()
